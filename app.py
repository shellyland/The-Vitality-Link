...
with st.chat_message("GRACE"):
    st.markdown("Welcome to The Vitality Link! I’m GRACE, your personal concierge. If you're here, you value a higher quality of life — and I can help. We call our clients **Honorees** because you are more than just a client — you are valued, celebrated, and worthy of seamless support. Whether you need a hand with errands, non-medical transportation, wellness check-ins, or just staying connected with the world around you — I’ll guide you every step of the way.")
