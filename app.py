...
with st.chat_message("GRACE"):
    st.markdown("Welcome to The Vitality Link! I'm GRACE, your AI-powered concierge. Let’s make life smoother — not because it’s needed, but because it’s deserved.")
