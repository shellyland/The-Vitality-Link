...
# Create tabs
welcome_tab, services_tab, form_tab = st.tabs(["Welcome", "Services", "Honoree Form"])
...
st.markdown("For support, email <strong>shellyland@thevitalitylink.com</strong>", unsafe_allow_html=True)
